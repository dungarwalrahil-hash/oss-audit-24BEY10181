# oss-audit-24BEY10181

This is my Open Source Software lab repo for auditing **Git** on **Ubuntu 24.04 (WSL2)**.

I’m **Rahil** (`Rahil`, reg no `24BEY10181`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
- `manifesto_Rahil.txt` - Example output from the manifesto generator
